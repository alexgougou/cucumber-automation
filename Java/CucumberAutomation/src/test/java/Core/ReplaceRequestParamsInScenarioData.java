...
public class ReplaceRequestParamsInScenarioData implements ReplaceRequestParamsStrategy
{
    @Override
    public <T> T perform(Map<String, Object> replaceTarget, String jsonPath, String dataSourceKey)
    {
        return replaceAccordingJsonPath(replaceTarget, jsonPath, scenarioData.get(dataSourceKey));
    }
}
